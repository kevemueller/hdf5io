 ...
 */
public interface SizingContextSOHMT extends SizingContext {
    int numberOfIndices();

    static SizingContextSOHMT of(final SizingContext sizingContext, final int numberOfIndices) {
        return new SizingContextSOHMT() {
            @Override
